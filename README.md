...
## Sponsorship
If you are interested in learning more about indirect syscalls or how to learn to improve your indirect syscalls shellcode loader and want access to the playbooks from the three bonus chapters, you can get access via a **one-time** [GitHub sponsorship](https://github.com/sponsors/VirtualAlllocEx) (High Tier or Company).
